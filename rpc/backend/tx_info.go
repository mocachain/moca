...
func (b *Backend) GetTransactionReceipt(hash common.Hash) (map[string]interface{}, error) {
	...
	// cosmos/evm v0.6.0: MsgEthereumTx.GetSender takes no arguments and
	// returns the recovered sender directly (no error). chainID is no
	// longer needed at this site.
	_ = chainID

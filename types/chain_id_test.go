...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "moca_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "MOCA_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Moca_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "moca_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "moca_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "moca_chain-1", true, nil,
		},
		{
			"invalid epoch, undefined", "moca_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "moca_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}

...
//
//	mockgen -source=x/challenge/types/expected_keepers.go -package types -destination x/challenge/types/expected_keepers_mocks.go
//
...
// ReleaseDepositLockUntil mocks base method.
func (m *MockSpKeeper) ReleaseDepositLockUntil(ctx types.Context, spID uint32, height uint64) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ReleaseDepositLockUntil", ctx, spID, height)
}

// ReleaseDepositLockUntil indicates an expected call of ReleaseDepositLockUntil.
func (mr *MockSpKeeperMockRecorder) ReleaseDepositLockUntil(ctx, spID, height any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReleaseDepositLockUntil", reflect.TypeOf((*MockSpKeeper)(nil).ReleaseDepositLockUntil), ctx, spID, height)
}

// SetDepositLockUntil mocks base method.
func (m *MockSpKeeper) SetDepositLockUntil(ctx types.Context, spID uint32, height uint64) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetDepositLockUntil", ctx, spID, height)
}

// SetDepositLockUntil indicates an expected call of SetDepositLockUntil.
func (mr *MockSpKeeperMockRecorder) SetDepositLockUntil(ctx, spID, height any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetDepositLockUntil", reflect.TypeOf((*MockSpKeeper)(nil).SetDepositLockUntil), ctx, spID, height)
}

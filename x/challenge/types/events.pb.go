...
// source: moca/challenge/events.proto
...
func (*EventStartChallenge) Descriptor() ([]byte, []int) {
	return fileDescriptor_d7a212cec0a7d30a, []int{0}
}
...
func (*EventAttestChallenge) Descriptor() ([]byte, []int) {
	return fileDescriptor_d7a212cec0a7d30a, []int{1}
}
...
func init() {
	proto.RegisterType((*EventStartChallenge)(nil), "moca.challenge.EventStartChallenge")
	proto.RegisterType((*EventAttestChallenge)(nil), "moca.challenge.EventAttestChallenge")
}

func init() { proto.RegisterFile("moca/challenge/events.proto", fileDescriptor_d7a212cec0a7d30a) }

var fileDescriptor_d7a212cec0a7d30a = []byte{
	// 537 bytes of a gzipped FileDescriptorProto
	,
}

...
func (FeePreviewType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_355e2d381620e82e, []int{0}
}
...
type EventStreamRecordUpdate struct {
	...
	FrozenNetflowRate cosmossdk_io_math.Int `protobuf:"bytes,4,opt,name=frozen_netflow_rate,json=frozenNetflowRate,proto3,customtype=cosmossdk.io/math.Int" json:"frozen_netflow_rate"`
	// The balance of the stream account at the latest CRUD timestamp.
	StaticBalance cosmossdk_io_math.Int `protobuf:"bytes,5,opt,name=static_balance,json=staticBalance,proto3,customtype=cosmossdk.io/math.Int" json:"static_balance"`
	// reserved balance of the stream account
	// If the netflow rate is negative, the reserved balance is `netflow_rate * reserve_time`
	BufferBalance cosmossdk_io_math.Int `protobuf:"bytes,6,opt,name=buffer_balance,json=bufferBalance,proto3,customtype=cosmossdk.io/math.Int" json:"buffer_balance"`
	// the locked balance of the stream account after it puts a new object and before the object is sealed
	LockBalance cosmossdk_io_math.Int `protobuf:"bytes,7,opt,name=lock_balance,json=lockBalance,proto3,customtype=cosmossdk.io/math.Int" json:"lock_balance"`
...
func (*EventStreamRecordUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_355e2d381620e82e, []int{1}
}
...
type EventForceSettle struct {
	...
	SettledBalance cosmossdk_io_math.Int `protobuf:"bytes,2,opt,name=settled_balance,json=settledBalance,proto3,customtype=cosmossdk.io/math.Int" json:"settled_balance"`
}
...
func (*EventForceSettle) Descriptor() ([]byte, []int) {
	return fileDescriptor_355e2d381620e82e, []int{2}
}
...
func (*EventDeposit) Descriptor() ([]byte, []int) {
	return fileDescriptor_355e2d381620e82e, []int{3}
}
...
func (*EventWithdraw) Descriptor() ([]byte, []int) {
	return fileDescriptor_355e2d381620e82e, []int{4}
}
...
func (*EventFeePreview) Descriptor() ([]byte, []int) {
	return fileDescriptor_355e2d381620e82e, []int{5}
}
...
func init() { proto.RegisterFile("moca/payment/events.proto", fileDescriptor_355e2d381620e82e) }

var fileDescriptor_355e2d381620e82e = []byte{
	// 730 bytes of a gzipped FileDescriptorProto
	,
}

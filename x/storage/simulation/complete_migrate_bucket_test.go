...
func TestSimulateMsgCompleteMigrateBucket(t *testing.T) {
	...
	op := simulation.SimulateMsgCompleteMigrateBucket(nil, nil, keeper.Keeper{})
	...
	require.Equal(t, types.TypeMsgCompleteMigrateBucket, opMsg.Name)

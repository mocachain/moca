...
func TestSimulateMsgMigrateBucket(t *testing.T) {
	...
	op := simulation.SimulateMsgMigrateBucket(nil, nil, keeper.Keeper{})
	...
	require.Equal(t, types.TypeMsgMigrateBucket, opMsg.Name)

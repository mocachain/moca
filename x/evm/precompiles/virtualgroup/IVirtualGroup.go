...
// CompleteSPExit is a paid mutator transaction binding the contract method 0x836733a8.
//
// Solidity: function completeSPExit(string operator) returns(bool success)
func (_IVirtualGroup *IVirtualGroupTransactor) CompleteSPExit(opts *bind.TransactOpts, operator string) (*types.Transaction, error) {
	return _IVirtualGroup.contract.Transact(opts, "completeSPExit", operator)
}

// CompleteSPExit is a paid mutator transaction binding the contract method 0x836733a8.
//
// Solidity: function completeSPExit(string operator) returns(bool success)
func (_IVirtualGroup *IVirtualGroupSession) CompleteSPExit(operator string) (*types.Transaction, error) {
	return _IVirtualGroup.Contract.CompleteSPExit(&_IVirtualGroup.TransactOpts, operator)
}

// CompleteSPExit is a paid mutator transaction binding the contract method 0x836733a8.
//
// Solidity: function completeSPExit(string operator) returns(bool success)
func (_IVirtualGroup *IVirtualGroupTransactorSession) CompleteSPExit(operator string) (*types.Transaction, error) {
	return _IVirtualGroup.Contract.CompleteSPExit(&_IVirtualGroup.TransactOpts, operator)
}

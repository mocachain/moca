...
//
// Solidity: event CancelUpdateObjectContent(address indexed operator, bytes32 indexed objectName)
func (_IStorage *IStorageFilterer) FilterCancelUpdateObjectContent(opts *bind.FilterOpts, operator []common.Address, objectName [][32]byte) (*IStorageCancelUpdateObjectContentIterator, error) {
...
//
// Solidity: event CancelUpdateObjectContent(address indexed operator, bytes32 indexed objectName)
func (_IStorage *IStorageFilterer) WatchCancelUpdateObjectContent(opts *bind.WatchOpts, sink chan<- *IStorageCancelUpdateObjectContent, operator []common.Address, objectName [][32]byte) (event.Subscription, error) {

...
// CancelUpdateObjectContent is a paid mutator transaction binding the contract method 0xbd2f5217.
//
// Solidity: function cancelUpdateObjectContent(string bucketName, string objectName) returns(bool success)
func (_IStorage *IStorageTransactor) CancelUpdateObjectContent(opts *bind.TransactOpts, bucketName string, objectName string) (*types.Transaction, error) {
	return _IStorage.contract.Transact(opts, "cancelUpdateObjectContent", bucketName, objectName)
}

// CancelUpdateObjectContent is a paid mutator transaction binding the contract method 0xbd2f5217.
//
// Solidity: function cancelUpdateObjectContent(string bucketName, string objectName) returns(bool success)
func (_IStorage *IStorageSession) CancelUpdateObjectContent(bucketName string, objectName string) (*types.Transaction, error) {
	return _IStorage.Contract.CancelUpdateObjectContent(&_IStorage.TransactOpts, bucketName, objectName)
}

// CancelUpdateObjectContent is a paid mutator transaction binding the contract method 0xbd2f5217.
//
// Solidity: function cancelUpdateObjectContent(string bucketName, string objectName) returns(bool success)
func (_IStorage *IStorageTransactorSession) CancelUpdateObjectContent(bucketName string, objectName string) (*types.Transaction, error) {
	return _IStorage.Contract.CancelUpdateObjectContent(&_IStorage.TransactOpts, bucketName, objectName)
}
...
// LeaveGroup is a paid mutator transaction binding the contract method 0x1aab4d1a.
//
// Solidity: function leaveGroup(address groupOwner, string groupName) returns(bool success)
func (_IStorage *IStorageTransactor) LeaveGroup(opts *bind.TransactOpts, groupOwner common.Address, groupName string) (*types.Transaction, error) {
	return _IStorage.contract.Transact(opts, "leaveGroup", groupOwner, groupName)
}

// LeaveGroup is a paid mutator transaction binding the contract method 0x1aab4d1a.
//
// Solidity: function leaveGroup(address groupOwner, string groupName) returns(bool success)
func (_IStorage *IStorageSession) LeaveGroup(groupOwner common.Address, groupName string) (*types.Transaction, error) {
	return _IStorage.Contract.LeaveGroup(&_IStorage.TransactOpts, groupOwner, groupName)
}

// LeaveGroup is a paid mutator transaction binding the contract method 0x1aab4d1a.
//
// Solidity: function leaveGroup(address groupOwner, string groupName) returns(bool success)
func (_IStorage *IStorageTransactorSession) LeaveGroup(groupOwner common.Address, groupName string) (*types.Transaction, error) {
	return _IStorage.Contract.LeaveGroup(&_IStorage.TransactOpts, groupOwner, groupName)
}
...
// SealObject is a paid mutator transaction binding the contract method 0x470e5ae0.
//
// Solidity: function sealObject(string bucketName, string objectName, uint32 globalVirtualGroupId, string secondarySpBlsAggSignatures) returns(bool success)
func (_IStorage *IStorageTransactor) SealObject(opts *bind.TransactOpts, bucketName string, objectName string, globalVirtualGroupId uint32, secondarySpBlsAggSignatures string) (*types.Transaction, error) {
	return _IStorage.contract.Transact(opts, "sealObject", bucketName, objectName, globalVirtualGroupId, secondarySpBlsAggSignatures)
}

// SealObject is a paid mutator transaction binding the contract method 0x470e5ae0.
//
// Solidity: function sealObject(string bucketName, string objectName, uint32 globalVirtualGroupId, string secondarySpBlsAggSignatures) returns(bool success)
func (_IStorage *IStorageSession) SealObject(bucketName string, objectName string, globalVirtualGroupId uint32, secondarySpBlsAggSignatures string) (*types.Transaction, error) {
	return _IStorage.Contract.SealObject(&_IStorage.TransactOpts, bucketName, objectName, globalVirtualGroupId, secondarySpBlsAggSignatures)
}

// SealObject is a paid mutator transaction binding the contract method 0x470e5ae0.
//
// Solidity: function sealObject(string bucketName, string objectName, uint32 globalVirtualGroupId, string secondarySpBlsAggSignatures) returns(bool success)
func (_IStorage *IStorageTransactorSession) SealObject(bucketName string, objectName string, globalVirtualGroupId uint32, secondarySpBlsAggSignatures string) (*types.Transaction, error) {
	return _IStorage.Contract.SealObject(&_IStorage.TransactOpts, bucketName, objectName, globalVirtualGroupId, secondarySpBlsAggSignatures)
}

// SealObjectV2 is a paid mutator transaction binding the contract method 0x7204c75e.
//
// Solidity: function sealObjectV2(string bucketName, string objectName, uint32 globalVirtualGroupId, string secondarySpBlsAggSignatures, string[] expectChecksums) returns(bool success)
func (_IStorage *IStorageTransactor) SealObjectV2(opts *bind.TransactOpts, bucketName string, objectName string, globalVirtualGroupId uint32, secondarySpBlsAggSignatures string, expectChecksums []string) (*types.Transaction, error) {
	return _IStorage.contract.Transact(opts, "sealObjectV2", bucketName, objectName, globalVirtualGroupId, secondarySpBlsAggSignatures, expectChecksums)
}

// SealObjectV2 is a paid mutator transaction binding the contract method 0x7204c75e.
//
// Solidity: function sealObjectV2(string bucketName, string objectName, uint32 globalVirtualGroupId, string secondarySpBlsAggSignatures, string[] expectChecksums) returns(bool success)
func (_IStorage *IStorageSession) SealObjectV2(bucketName string, objectName string, globalVirtualGroupId uint32, secondarySpBlsAggSignatures string, expectChecksums []string) (*types.Transaction, error) {
	return _IStorage.Contract.SealObjectV2(&_IStorage.TransactOpts, bucketName, objectName, globalVirtualGroupId, secondarySpBlsAggSignatures, expectChecksums)
}

// SealObjectV2 is a paid mutator transaction binding the contract method 0x7204c75e.
//
// Solidity: function sealObjectV2(string bucketName, string objectName, uint32 globalVirtualGroupId, string secondarySpBlsAggSignatures, string[] expectChecksums) returns(bool success)
func (_IStorage *IStorageTransactorSession) SealObjectV2(bucketName string, objectName string, globalVirtualGroupId uint32, secondarySpBlsAggSignatures string, expectChecksums []string) (*types.Transaction, error) {
	return _IStorage.Contract.SealObjectV2(&_IStorage.TransactOpts, bucketName, objectName, globalVirtualGroupId, secondarySpBlsAggSignatures, expectChecksums)
}
...
// IStorageCancelUpdateObjectContentIterator is returned from FilterCancelUpdateObjectContent and is used to iterate over the raw logs and unpacked data for CancelUpdateObjectContent events raised by the IStorage contract.
type IStorageCancelUpdateObjectContentIterator struct {
	Event *IStorageCancelUpdateObjectContent // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IStorageCancelUpdateObjectContentIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IStorageCancelUpdateObjectContent)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IStorageCancelUpdateObjectContentIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IStorageCancelUpdateObjectContentIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IStorageCancelUpdateObjectContent represents a CancelUpdateObjectContent event raised by the IStorage contract.
type IStorageCancelUpdateObjectContent struct {
	Operator   common.Address
	ObjectName common.Hash
	Raw        types.Log // Blockchain specific contextual infos
}

// FilterCancelUpdateObjectContent is a free log retrieval operation binding the contract event 0x1377654dd8e5ff1001eb309edc8042b3b60723f2ae547bf509b307ebe31813af.
//
// Solidity: event CancelUpdateObjectContent(address indexed operator, string indexed objectName)
func (_IStorage *IStorageFilterer) FilterCancelUpdateObjectContent(opts *bind.FilterOpts, operator []common.Address, objectName []common.Hash) (*IStorageCancelUpdateObjectContentIterator, error) {
	...
	logs, sub, err := _IStorage.contract.FilterLogs(opts, "CancelUpdateObjectContent", operatorRule, objectNameRule)
	if err != nil {
		return nil, err
	}
	return &IStorageCancelUpdateObjectContentIterator{contract: _IStorage.contract, event: "CancelUpdateObjectContent", logs: logs, sub: sub}, nil
}

// WatchCancelUpdateObjectContent is a free log subscription operation binding the contract event 0x1377654dd8e5ff1001eb309edc8042b3b60723f2ae547bf509b307ebe31813af.
//
// Solidity: event CancelUpdateObjectContent(address indexed operator, string indexed objectName)
func (_IStorage *IStorageFilterer) WatchCancelUpdateObjectContent(opts *bind.WatchOpts, sink chan<- *IStorageCancelUpdateObjectContent, operator []common.Address, objectName []common.Hash) (event.Subscription, error) {
	...
	logs, sub, err := _IStorage.contract.WatchLogs(opts, "CancelUpdateObjectContent", operatorRule, objectNameRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IStorageCancelUpdateObjectContent)
				if err := _IStorage.contract.UnpackLog(event, "CancelUpdateObjectContent", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseCancelUpdateObjectContent is a log parse operation binding the contract event 0x1377654dd8e5ff1001eb309edc8042b3b60723f2ae547bf509b307ebe31813af.
//
// Solidity: event CancelUpdateObjectContent(address indexed operator, string indexed objectName)
func (_IStorage *IStorageFilterer) ParseCancelUpdateObjectContent(log types.Log) (*IStorageCancelUpdateObjectContent, error) {
	event := new(IStorageCancelUpdateObjectContent)
	if err := _IStorage.contract.UnpackLog(event, "CancelUpdateObjectContent", log); err != nil {
		return nil, err
	}
...
// FilterSealObject is a free log retrieval operation binding the contract event 0xd6134e68e5f7e1c6d9ca7b32112429a96b71fbf1678a07562ab59f4e773c97b6.
//
// Solidity: event SealObject(address indexed creator)
func (_IStorage *IStorageFilterer) FilterSealObject(opts *bind.FilterOpts, creator []common.Address) (*IStorageSealObjectIterator, error) {
	...
	logs, sub, err := _IStorage.contract.FilterLogs(opts, "SealObject", creatorRule)
	if err != nil {
		return nil, err
	}
...
// WatchSealObject is a free log subscription operation binding the contract event 0xd6134e68e5f7e1c6d9ca7b32112429a96b71fbf1678a07562ab59f4e773c97b6.
//
// Solidity: event SealObject(address indexed creator)
func (_IStorage *IStorageFilterer) WatchSealObject(opts *bind.WatchOpts, sink chan<- *IStorageSealObject, creator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IStorage.contract.WatchLogs(opts, "SealObject", creatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseSealObject is a log parse operation binding the contract event 0xd6134e68e5f7e1c6d9ca7b32112429a96b71fbf1678a07562ab59f4e773c97b6.
//
// Solidity: event SealObject(address indexed creator)
...
// FilterSealObjectV2 is a free log retrieval operation binding the contract event 0x1685b1ae3d9079aa4c5a13ee5ce8b418c6211474fcb42d574dd88161282bc840.
//
// Solidity: event SealObjectV2(address indexed creator)
func (_IStorage *IStorageFilterer) FilterSealObjectV2(opts *bind.FilterOpts, creator []common.Address) (*IStorageSealObjectV2Iterator, error) {
	...
	logs, sub, err := _IStorage.contract.FilterLogs(opts, "SealObjectV2", creatorRule)
	if err != nil {
		return nil, err
	}
...
// WatchSealObjectV2 is a free log subscription operation binding the contract event 0x1685b1ae3d9079aa4c5a13ee5ce8b418c6211474fcb42d574dd88161282bc840.
//
// Solidity: event SealObjectV2(address indexed creator)
func (_IStorage *IStorageFilterer) WatchSealObjectV2(opts *bind.WatchOpts, sink chan<- *IStorageSealObjectV2, creator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IStorage.contract.WatchLogs(opts, "SealObjectV2", creatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseSealObjectV2 is a log parse operation binding the contract event 0x1685b1ae3d9079aa4c5a13ee5ce8b418c6211474fcb42d574dd88161282bc840.
//
// Solidity: event SealObjectV2(address indexed creator)

...
// FilterCancelUpdateObjectContent is a free log retrieval operation binding the contract event 0xd313b32a74176e97df929d0c08d501b5071bbbdf9e4cec15ecd04f6a23be6374.
//
// Solidity: event CancelUpdateObjectContent(address indexed operator, string indexed objectName)
func (_IStorage *IStorageFilterer) FilterCancelUpdateObjectContent(opts *bind.FilterOpts, operator []common.Address, objectName []string) (*IStorageCancelUpdateObjectContentIterator, error) {
...
// WatchCancelUpdateObjectContent is a free log subscription operation binding the contract event 0xd313b32a74176e97df929d0c08d501b5071bbbdf9e4cec15ecd04f6a23be6374.
//
// Solidity: event CancelUpdateObjectContent(address indexed operator, string indexed objectName)
func (_IStorage *IStorageFilterer) WatchCancelUpdateObjectContent(opts *bind.WatchOpts, sink chan<- *IStorageCancelUpdateObjectContent, operator []common.Address, objectName []string) (event.Subscription, error) {
...
// ParseCancelUpdateObjectContent is a log parse operation binding the contract event 0xd313b32a74176e97df929d0c08d501b5071bbbdf9e4cec15ecd04f6a23be6374.
//
// Solidity: event CancelUpdateObjectContent(address indexed operator, string indexed objectName)

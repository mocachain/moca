...
func PrepareAccountsForDelegationRewards(t *testing.T, ctx sdk.Context, app *app.Moca, addr sdk.AccAddress, balance sdkmath.Int, rewards ...sdkmath.Int) (sdk.Context, error) {
	...
	for _, reward := range rewards {
		...
		allocatedRewards := sdk.NewDecCoins(sdk.NewDecCoin(utils.BaseDenom, reward.Mul(sdkmath.NewInt(2))))
